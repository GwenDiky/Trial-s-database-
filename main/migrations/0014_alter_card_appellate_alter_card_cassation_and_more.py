...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('main', '0013_alter_firstdispute_value'),
    ]
    ...
    operations = [
        migrations.AlterField(
            model_name='card',
            name='appellate',
            field=models.CharField(blank=True, choices=[('None', ''), ('Нет', 'Нет'), ('Изменено', 'Изм.'), ('Отказано', 'Отк.')], max_length=200, null=True, verbose_name='Решение апелляционной инстанции'),
        ),
        migrations.AlterField(
            model_name='card',
            name='cassation',
            field=models.CharField(blank=True, choices=[('None', ''), ('Нет', 'Нет'), ('Изменено', 'Изм.'), ('Отказано', 'Отк.')], max_length=200, null=True, verbose_name='Решение кассационной инстанции'),
        ),
        migrations.AlterField(
